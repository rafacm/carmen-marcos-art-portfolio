            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    <div class="card flex-md-row mb-4 box-shadow h-md-250">
                        <div class="card-body d-flex flex-column align-items-start">
                            ...
                            <h3 class="mb-0">Bild Wein Schau 2018</h3>
                            <div class="mb-1 text-muted">Samstag 26. Mai, ab 14:00 Uhr</div>
                ...
                <div class="col-md-6">
                    <div class="card flex-md-row mb-4 box-shadow h-md-250">
                        <div class="card-body d-flex flex-column align-items-start">
                            <strong class="d-inline-block mb-2 text-primary">Exhibition</strong>
                            <h3 class="mb-0">Galerie Sandpeck</h3>
                            <div class="mb-1 text-muted">Sonntag, 8. Juli 2018</div>
                            <p class="card-text mb-auto">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
